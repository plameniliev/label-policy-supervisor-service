...
build-controller:
	docker build -f controller/Dockerfile -t harbor.cloudlab.cx/piliev/label-policy-service/controller:${VERSION} controller/.
release-controller:
	docker push harbor.cloudlab.cx/piliev/label-policy-service/controller:${VERSION}
